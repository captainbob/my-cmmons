...
export default class Image extends Component {
    ...
    onError = (event) => {
        ...
        if (size <= 200) {
            this.setState({ src: 'http://img.amugua.com/vpc/1/spu/img_default1494487963106.jpg@!a200-200' })
        } else {
            this.setState({ src: 'http://img.amugua.com/vpc/1/spu/img_default1494487963106.jpg' })
        }
    }
